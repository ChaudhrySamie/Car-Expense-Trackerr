...
import {  View, Text, StyleSheet, TouchableOpacity, FlatList, TextInput, ActivityIndicator,  KeyboardAvoidingView, Platform, Modal, ScrollView, TouchableWithoutFeedback, Keyboard, Dimensions  } from 'react-native';
